...
export class Migration1742462912134 implements MigrationInterface {
    name = 'Migration1742462912134'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "shotgun-waitlist" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_1208e9abf301e3dc8db20aaa783" DEFAULT NEWSEQUENTIALID(), "createdAt" datetime NOT NULL CONSTRAINT "DF_280353bad4107b2ce768d4179c8" DEFAULT GETUTCDATE(), "updatedAt" datetime NOT NULL CONSTRAINT "DF_0a8a50b2a7660a0008f694691fe" DEFAULT GETUTCDATE(), "referenceId" varchar(255) NOT NULL, "finalReferenceId" varchar(255), "stripeCustomerId" varchar(255), "firstName" varchar(255) NOT NULL, "lastName" varchar(255), "email" varchar(255) NOT NULL, "status" varchar(255) NOT NULL CONSTRAINT "DF_2d0e2f9c60063c7aac8e662b759" DEFAULT 'pending', "country" varchar(255) NOT NULL, "addressLineOne" varchar(255), "addressLineTwo" varchar(255), "city" varchar(255), "state" varchar(255), "postalCode" varchar(255), "source" varchar(255) NOT NULL CONSTRAINT "DF_397b4bc80e01e49d6e1feaf4fdb" DEFAULT 'waitlist', "quantity" bigint NOT NULL CONSTRAINT "DF_aa1ce31b6d5a27abd4dcb6cf06e" DEFAULT 1, "completedAt" datetime, CONSTRAINT "UQ_d36d41b150980cf17d07ae8df8c" UNIQUE ("referenceId"), CONSTRAINT "PK_1208e9abf301e3dc8db20aaa783" PRIMARY KEY ("id"))`);
